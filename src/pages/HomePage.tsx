...
export function HomePage({ navigateTo }: HomePageProps) {
    return (
        <div>
            <section className="bg-cover bg-center h-[60vh] md:h-[80vh]" style={{ backgroundColor: '#282c34'}}>
                <div className="bg-black bg-opacity-60 h-full flex items-center">
                    <div className="container mx-auto px-6 text-center text-white">
                        <h1 className="text-4xl md:text-6xl font-black mb-4 leading-tight text-brand-gold">Expert UK Immigration & Visa Advice</h1>
                        ...
                        <button onClick={() => navigateTo('Contact')} className="bg-brand-gold hover:opacity-90 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300 transform hover:scale-105">
                            Book a Consultation
                        </button>
                    </div>
                </div>
            ...
            <section className="py-20 bg-brand-light">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-3xl mb-6">Your Trusted Partner in Immigration</h2>
                    ...
                    <button onClick={() => navigateTo('About Us')} className="text-brand-gold hover:underline font-semibold text-lg">
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <h2 className="text-3xl text-center mb-12">Our Core Services</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <ServiceCard
                            icon={<BriefcaseIcon className="w-12 h-12 text-brand-gold mb-4" />}
                        ...
                        />
                        <ServiceCard
                            icon={<UsersIcon className="w-12 h-12 text-brand-gold mb-4" />}
                        ...
                        />
                        <ServiceCard
                            icon={<HomeIcon className="w-12 h-12 text-brand-gold mb-4" />}
                    ...
                    <div className="text-center mt-12">
                        <button onClick={() => navigateTo('Our Services')} className="bg-brand-gold hover:opacity-90 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300">
                            View All Services
                        </button>
                    </div>
                </div>
